...
@Setter
@Getter
public class SearchDrugWrapper extends Response implements Serializable{
	
	private static final long serialVersionUID = 4211593995472137371L;
	private List<PharmacyNewDrugQtyControllerDto> objPharmacyNewDrugQtyControllerDto;
