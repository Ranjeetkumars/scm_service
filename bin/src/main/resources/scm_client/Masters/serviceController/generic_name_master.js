...
function saveGenericName() {
	...
	alert('@@@@@@@@@@@@@@@@@@@@@@@@@@@@@');
	var strUrl = "http://localhost:2000/scmservice/GenericNameController/saveGenericNames"
	$
			.ajax({
				type : "POST",
				url : strUrl,
...
function loadGenericData() {
	...
	var strUrl = "http://localhost:2000/scmservice/GenericNameController/getdrugsName";
	...
	$.ajax({
		...
		async : false,
		success : function(data) {
			// alert(data.objGenericNameControllerDTO);
...
function updateGenericDetails() {
	...
	var description = $('#description_id').val();
	var isStatus = ($('input:checkbox[name=checkme]').is(':checked'));
	var strUrl = "http://localhost:2000/scmservice/GenericNameController/updateGenericName";
