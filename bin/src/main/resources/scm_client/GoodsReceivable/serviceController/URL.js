...
Service = {
        ...
        LOAD_ZONES: 'http://' + SYSTEM_IP + '/expiryDrugsController/api/version_1/load_zones',
        LOAD_BASELOCATIONS: 'http://' + SYSTEM_IP + '/expiryDrugsController/api/version_1/load_baselocations',
        LOAD_VEHICLES: 'http://' + SYSTEM_IP + '/expiryDrugsController/api/version_1/load_vehicles',
        
        LOAD_SUBSTORE: 'http://' + SYSTEM_IP + '/expiryDrugsController/api/version_1/loadSubStore',
