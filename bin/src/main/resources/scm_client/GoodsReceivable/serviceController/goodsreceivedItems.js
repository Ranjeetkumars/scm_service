...
function getAllReceivedGoodsSearch() {
	try {
		...
		var strUrl = Service.GET_ALL_RECEIVED_GOODS;
...
function getAllReceivedGoodsByIndentId(po_id) {
	try {
		...
		var strUrl = Service.GET_ALL_RECEIVED_GOODS_BY_INDENT_ID;
...
function getTermsConditions(poid) {
	...
	var strUrl = Service.GET_TERMS_CONDITIONS;
...
function savePodetails() {
	...
	var strUrl = Service.SAVE_RECEIVED_GOODS;
...
function updatePoData() {
	...
	var strUrl = Service.UPDATE_PO_ITEMS;
...
function updateStatus() {
	...
	var strUrl = Service.UPDATE_STATUS;
