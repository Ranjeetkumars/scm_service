function editItemDetails(serialId) {
    ...
    var strUrl = "http://localhost:2000/scmservice/salesIndentRaisedController/getMedicinesDetailsBasedOnSerialId";
     var objSerailId={
    	"serialId":serialId	
    };
    $.ajax({
        ...
        success: function(data) {
        	alert("json data is comming::"+JSON.stringify(data));
        	var jsonArray = data.objControllerDto;
            alert("jsonArray"+jsonArray[0].genericName);
...
function loadDataTable() {
	alert('loadDataTable is executed');
