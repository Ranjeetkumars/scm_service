...
function getActive_Inactive_Item() {
	...
	try {
		var strUrl = "http://localhost:2000/scmservice/drugRegisteringService/getAllActiveInactiveCount";
...
function getAllActiveInactive(jsonObj) {
	...
	try {
		var strUrl = "http://localhost:2000/scmservice/drugRegisteringService/getAllActiveInactive";
		console.log("loadForm Url is:" + strUrl);
		$
				.ajax({
					type : "POST",
...
function activeInactiveItem() {
	...
	var strUrl = "http://localhost:2000/scmservice/salesIndentRaisedController/saveInActiveDrugs"
