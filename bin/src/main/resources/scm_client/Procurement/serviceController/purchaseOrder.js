...
function getIndentDropdown() {
	try {
		$('#indent_id').empty();
		var strUrl = Service.LOAD_INDENTS;
...
function getAllIndentData(indent_id) {
	try {
		...
		var strUrl = Service.INDENT_DETAILS;
...
function generatePoNumber() {
	...
	var po_number;
	try {
		var strUrl = Service.GENERATE_PO_NUMBER;
...
//		alert("poNUMBER: " + po_id);
		...
		var strUrl = Service.SAVE_PURCHASE_ORDER;
...
var suuplir_id = $('#centrelsubstore'+position_id).val();
		...
		var strUrl = Service.SAVE_PURCHASE_ORDER_ITEM_DETAILS;
...
//		var expected_date_id = $('#expected_date_id').val();
		...
		var strUrl = Service.CENTRAL_CLOSE;
