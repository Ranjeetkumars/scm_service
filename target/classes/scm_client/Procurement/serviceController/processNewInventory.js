...
function getProcessNewInventory() {
	...
	$('#processNewInventoryId').dataTable().fnClearTable();
	$('#processNewInventoryId').dataTable().fnDestroy();
	$('#new_process_list_of_data').empty();
	try {
...
function addLatestItem(){
	//window.location.href="http://localhost:2000//scmservice/Procurement/pages/IndentRequest.html";
